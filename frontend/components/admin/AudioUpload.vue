  ...
  <div class="space-y-6">
    ...
    <div class="rounded-2xl border border-gray-200 p-4 space-y-3">
      ...
      >
        ...
        <span v-if="uploadingVi">{{ $t('common.uploading') }}</span>
        <span v-else>{{ audioViUrl ? $t('admin.replace_audio') : $t('admin.upload_audio') }}</span>
        <input
          ref="inputVi"
          type="file"
          accept=".mp3,audio/*"
    ...
    <div class="rounded-2xl border border-gray-200 p-4 space-y-3">
      ...
      >
        ...
        <span v-if="uploadingEn">{{ $t('common.uploading') }}</span>
        <span v-else>{{ audioEnUrl ? $t('admin.replace_audio') : $t('admin.upload_audio') }}</span>
        <input
          ref="inputEn"
          type="file"
          accept=".mp3,audio/*"
