<template>
  <div class="space-y-3">
    ...
    <div class="rounded-xl border border-gray-200 p-3 space-y-2">
      ...
      />
      <label
        class="inline-flex items-center gap-2 cursor-pointer text-sm font-medium rounded-xl border border-dashed border-brand-400 px-3 py-2 text-brand-600 hover:bg-brand-50 transition-colors"
